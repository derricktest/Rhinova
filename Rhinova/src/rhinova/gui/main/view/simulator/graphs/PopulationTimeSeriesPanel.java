...
public class PopulationTimeSeriesPanel extends SimulatedResultsChartPanel implements ApplicationListener<ApplicationEvent>  {
	...
	public PopulationTimeSeriesPanel() {
		...
		
 {
			...
			if (ev instanceof SimulationEvent) {
				...
				this.setData(event.getResuts().getPopulationsTimeSeries());
	...
	/// this.setData(ev.getResuts().getPopulationsTimeSeries());

	@Override
	public String toString() {
		return "All Populations Time Series";
	}
